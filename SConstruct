...
sources = [
    Glob('src/*.cpp'),
    Glob('src/cpp_redis/sources/builders/*.cpp'),
    Glob('src/cpp_redis/sources/core/*.cpp'),
    Glob('src/cpp_redis/sources/misc/*.cpp'),
    Glob('src/cpp_redis/sources/network/*.cpp'),
    Glob('src/cpp_redis/tacopie/sources/utils/*.cpp'),
    Glob('src/cpp_redis/tacopie/sources/network/*.cpp'),
    Glob('src/cpp_redis/tacopie/sources/network/common/*.cpp'),
    Glob('src/cpp_redis/tacopie/sources/network/unix/*.cpp'),
    Glob('src/cpp_redis/tacopie/sources/network/windows/*.cpp'),

    Glob('src/cpp_redis/builders/*.cpp'),
    Glob('src/cpp_redis/sources/core/*.cpp'),
    Glob('src/cpp_redis/sources/misc/*.cpp'),
    Glob('src/cpp_redis/sources/network/*.cpp'),
]
